                                ...
                                <td style="width: 100%;">
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;" >
                                            Your package {{$package_name}} expired on {{$end_date}}. Renew now or choose a new plan to continue enjoying our services!                                       
                                        </p> 
                                        <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;" >
                                            <a href="{{route('packages')}}">Click here</a> to go on package page.                                      
                                        </p> 
                                    </div>
                                </td>
                            </tr>
