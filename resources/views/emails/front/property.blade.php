                                ...
                                <td style="width: 100%;">
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        <p style="float: left; width: 100%; text-align: center; color: #acacac; margin-bottom: 0;" >
                                            Someone showing interest in your property.  <a href="{{ route('user.property.enquiries')}}" style="color: #000;">Click here</a> to find.                                          
                                        </p>
                                        @if (isset($property_name))
                                        <p><a href="{{ $property_url }}" style="color: #000;">{{$property_name}}</a></p>
                                        @endif 
                                    </div>
                                </td>
                            </tr>
