...
@endphp
    <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-wrap">
                            <img class="lazyload" data-src="{{ url('frontend/images/section/section-contact-2.jpg')}}"
                                src="{{ url('frontend/images/section/section-contact-2.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        @include('front.layouts.work-together')
