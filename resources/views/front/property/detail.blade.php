                                    ...
                                    <div class="box-house hover-img">
                                        <div class="image-wrap">
                                            ...
                                            <div class="list-btn flex gap-8 ">
                                                <a href="{{route('user.favorite.add', $row->id)}}" class="btn-icon save hover-tooltip"><i class="icon-save"></i>
                                                    <span class="tooltip">Add Favorite</span>
                                                </a>
                                                <a href="{{route('property', $row->id)}}" class="btn-icon find hover-tooltip"><i class="icon-find-plus"></i>
