...
@section('content')
    ...
    <div class="main-content ">
                ...
                <div class="wrap-categories-sw">
                    <div class="swiper tf-sw-categories style-pagination" data-preview="6" data-tablet="4"
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('properties', ['property_detail' => 'villa']) }}" class="categories-item">
                                    <div class="icon-box">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('properties', ['property_detail' => 'studio']) }}" class="categories-item active">
                                    <div class="icon-box">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('properties', ['property_detail' => 'office']) }}" class="categories-item">
                                    <div class="icon-box">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('properties', ['type' => 'commercial']) }}" class="categories-item">
                                    <div class="icon-box">
                                    ...
                                    <div class="box-house hover-img ">
                                        <div class="image-wrap">
                                            ...
                                            <div class="list-btn flex gap-8 ">
                                                {{-- <a href="{{route('user.favorite.toggle', $row->id)}}" class="btn-icon save hover-tooltip"><i
                                                    class="icon-save"></i>
        ...
        <!-- /.section-listing -->
                ...
                <section class="section-neighborhoods d-none">
                ...
                <section class="section-listing tf-spacing-1">
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12">
                                <div class="heading-section text-center mb-48">
                                    <h2 class="title text-anime-wave">Popular Listings</h2>
                                    <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                                        data-wow-delay="0s">Thousands of luxury home enthusiasts just like you
                                        visit our website.
                                    </p>
        ...
        <div class="section-testimonials style-1 tf-spacing-1">
            <div class="tf-container">
                <div class="row">
                    <div class="col-12">
                        <div class="heading-section text-center mb-48">
                            <h2 class="title text-anime-wave">What’s people say’s</h2>
                            <p class="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                                data-wow-delay="0s">Our seasoned team excels in real estate with years of successful market navigation, offering informed decisions and optimal results.
                            </p>
                        </div>
                                ...
                                <div class="wg-testimonial style-2">
                                    ...
                                    <div class="author">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="text-2">{{$testimonial->position}}</p>
                                        </div>
                                    </div>
                                </div>  
                            </div>
