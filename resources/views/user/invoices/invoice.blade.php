        ...
        <table width="100%" class="InvoiceTable" border="0" cellspacing="0" cellpadding="0"
            ...
            <tr>
                ...
                <td>
                    ...
                    <p>GST No.: {{ config('constants.CONTACT.gst_no')}}</p>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    ...
                    <table cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr class="alignTr" style="background-color:#ddd;">
                                ...
                                <td>
                                    <h6 class="para">HSN Code</h6>
                                </td>
                                <td>
                                    <h6 class="para">Package Price</h6>
                                </td>
                                <td>
                            ...
                            <tr style="border-bottom: 1px solid #ddd;" class="alignTr">
                                ...
                                <td>
                                    <p style="font-weight: bold; font-size: 12px;">{{ config('constants.CONTACT.HSN_Code')}}</p>
                                </td>
                                <td>
                            ...
                            <tr style="border-bottom: 1px solid #ddd;">
                                ...
                                <td colspan="1" style="width:100px; display:block;">Total GST (+18%):</td>
